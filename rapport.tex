...
Le modele fait des predictions sur les donnees de test, et je calcule sa precision. Resultat : \textbf{89.50\%} de precision, soit 9 predictions correctes sur 10. Pas mal !
...
\subsection{Bonus : Test avec Naive Bayes}
...
J'ai aussi teste Naive Bayes pour comparer, mais Decision Tree marchait mieux donc c'est celui que j'ai garde pour le dashboard.
...
\begin{itemize}
    \item Precision du modele : \textbf{89.50\%}
...
Les resultats sont plutot bons : 89.50\% de precision, ca veut dire que le modele se trompe rarement. Le Decision Tree est vraiment adapte pour ce genre de probleme avec des donnees mixtes (texte et chiffres).
...
\textbf{\color{primaryblue}En bref :} Un bon projet de ML qui marche, avec un modele qui predit correctement et une interface sympa pour le tester.
